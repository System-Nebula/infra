...
func (n *NetCfg) CreateSubnet(ctx *pulumi.Context, subnetIndex int, vcnID string) (*core.Subnet, error) {
...
func (n *NetCfg) CreateAllSubnets(ctx *pulumi.Context, vcnID string) ([]*core.Subnet, error) {
	var subnets []*core.Subnet

	for i := range n.Subnets {
		subnet, err := n.CreateSubnet(ctx, i, vcnID)
		if err != nil {
			return nil, err
		}
